...
const DisplayDistributorProfile = ({navigation}) => {
  ...
  const checkConnection = async () => {
    try {
      ...
      await client
        .post('/partner/checkPartnerConnection', data)
  ...
  const connect = async () => {
    try {
      ...
      await client
        .post('/partner/addPartner', connectionData)
        .then(function (response) {
  ...
  const unfriend = async () => {
    try {
      ...
      await client
        .post('/partner/rejectPartner', connectionData)
        .then(function (response) {
          // console.log(response.data);
  ...
  const withdrawRequest = async () => {
    try {
      ...
      await client
        .post('/partner/withdrawRequest', connectionData)
        .then(function (response) {
          // console.log(response.data);
          setIsRequestSent(false);
          setAccepted(false);
  ...
  const checkAcceptedConnection = async () => {
    try {
      ...
      await client
        .post('/partner/checkAcceptedPartner', data)
        .then(function (response) {
        ...
        {accepted ? (
          ...
          <View style={{justifyContent: 'center', alignItems: 'center'}}>
            <TouchableOpacity
              ...
              <Text style={styles.AddProducerText}>Add Distributor</Text>
            </TouchableOpacity>
          </View>
        ) : (
          <View></View>
...
export default DisplayDistributorProfile;
